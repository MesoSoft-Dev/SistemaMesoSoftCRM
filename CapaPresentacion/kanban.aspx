...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1" runat="server">
        ...
        <div class="mx-3">
            <button id="btn+oportunidad" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#todo_form" type="button">
                + Oportunidad
            </button>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" class="btn btn-success btn-block" id="todo_submit">Agregar tarea</button>
                    </div>
                </div>
            </div>
        </div>
