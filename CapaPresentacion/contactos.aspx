...
<div class="container">
   <div class="row d-flex align-items-start flex-column flex-sm-row my-3">
       <div class="col">
         <label>Nombres</label>
...
<div class="container">
     <div class="row d-flex align-items-start flex-column flex-sm-row my-3">
      <div class="col">
        ...
        <asp:DropDownList ID="ddlTipoContacto" runat="server" CssClass="form-control w-75 my-auto">
        <asp:ListItem Text="Seleccione una opcion" Value=""/>  
