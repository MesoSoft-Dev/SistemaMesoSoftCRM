<%@ Page Title="Login" Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="CapaPresentacion._Default" ClientIDMode="Static" Async="true" %>
    ...
    <form id="form1" class="w-100 " runat="server">
        ...
        <div class="container ">
            <div class="login-box bg-opacity-50 bg-white p-0 m-0 rounded-0 align-content-center justify-content-center">
                ...
                </div> <!-- Fin sección inicio de sesión -->

                <!-- Sección de cambiar contraseña -->
                <div id="changePasswordSection" class="hidden pb-1 mb-1">
                    <div class="pt-0 mt-0 pb-3 px-4 rounded-0 change-password">
                        <p class="py-0 my-0  fw-bold">Empresa</p>
                        <asp:TextBox ID="txtCurrentCompany" runat="server" CssClass="form-control " Placeholder="Ingresa Empresa" />
                        <p class="py-0 my-0 fw-bold">Usuario</p>
                        <asp:TextBox ID="txtCurrentUser" runat="server" CssClass="form-control" Placeholder="Ingresa Usuario" />
                        ...
                        <div class="d-flex justify-content-center">
                            <asp:Button ID="btnChangePassword" runat="server" Class="btn incBoton w-100 my-3" Text="Cambiar" OnClick="btnChangePassword_Click" />
                        </div>
                        <br />
                    </div>
                ...
                </div> <!-- Fin sección cambiar contraseña -->
                ...
                <div id="forgotPasswordSection" class="hidden ">
                    <div class="remember-password px-4 mt-0 pt-0 rounded-0">
                        <p class="py-0 my-0 fw-bold">Empresa</p>
                        <asp:TextBox ID="txtCurrentCompanyFP" runat="server" Class="form-control" Placeholder="Ingresar Empresa" />
                        <p class="py-0 my-0 fw-bold">Usuario</p>
                        <asp:TextBox ID="txtCurrentUserFP" runat="server" Class="form-control" Placeholder="Ingresar Usuario" />
                        <!--<p class="py-0 my-0 fw-bold">Contraseña</p>
                        <asp:TextBox ID="txtCurrentPasswordFP" runat="server" Class="form-control " Placeholder="Ingresar Contraseña" />
                        -->
